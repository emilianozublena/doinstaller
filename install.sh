#ingresamos a la carpeta publica
cd /var/www/html/
...
echo "Vas a utilizar el public storage de laravel? (si/no)"
read public_storage
if [ "$public_storage" = "si" ]
then
	php artisan storage:link
fi
echo "Instalado, recorda ejecutar virtual_hosts.sh si necesitas crear los hosts virtuales de apache ;)"